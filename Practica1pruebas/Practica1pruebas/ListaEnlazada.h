...
//muy importante el friend
    ...
    public:
        ...
        Iterador& operator++() {
            if (actual == nullptr) {
                ...
                if (actual == nullptr) {
                     throw std::out_of_range("Intento de avanzar un iterador nulo o al final.");
                }
            }
            actual = actual->sig;
            return *this;
        ...
        T& operator*() {
            if (actual == nullptr) {
                throw std::out_of_range("Intento de desreferenciar un iterador nulo.");
            }
            return actual->dato;
        }
        ...
        const T& operator*() const {
            if (actual == nullptr) {
                throw std::out_of_range("Intento de desreferenciar un iterador nulo (const).");
            }
            return actual->dato;
        }
    ...
    void insertaDetras(Iterador& i, T& dato) {
        ...
        if (i.actual == _fin) { // Caso especial: se inserta un nuevo final (O(1))
            _fin = nuevo;
        }
    }
    ...
    void borra(Iterador& i) {
        ...
        if (i.actual == _inicio) {
            ...
            if (anterior == nullptr) {
                throw std::out_of_range("El iterador no pertenece a la lista o es inválido.");
            }
