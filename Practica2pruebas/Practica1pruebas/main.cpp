...
**/
    ...
    MediEXp.buscarYMostrarLabsGranada();
    MediEXp.indicarCuantosLabsJaen();
    MediEXp.indicarYMostrarLaboratoriosMadrid();
    MediEXp.asignarLabsAMedicamentosSinSuministrador();

    MediEXp.mostrarLabsSuministranAceites();

    // Ejecutar la función para parejas
    MediEXp.eliminarLabsBruselas();
